...
class PlayerProxy(object):
	...
	def concealedKong(self, tile):
		...
		# 算分
		self.owner.cal_kong_score(self.idx, self.idx, const.OP_CONCEALED_KONG, 1)
	...
	def exposedKong(self, tile):
		...
		# 算分
		self.owner.cal_kong_score(self.idx, self.owner.last_player_idx, const.OP_EXPOSED_KONG, 1)
	...
	def continueKong(self, tile):
		...
		# 算分
		self.owner.cal_kong_score(self.idx, self.idx, const.OP_CONTINUE_KONG, 1)
		self.owner.last_player_idx = self.idx
	...
	def discardTile(self, tile = None):
		...
		self.owner.follow_dealer(self.idx, tile)
		self.discard_tiles.append(tile)
